...
class Alipay
{
    ...
    //私钥值
    public $rsaPrivateKey="";
    //网关
    ...
    //public $alipayrsaPublicKey ="/Pay/payment/rsa_public_key.pem";
    public $alipayrsaPublicKey ="MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQC4t6Er1FnssU51Xbf3RxRhu11U7nZXl8yRx+VjRqCZJ9gJHj0tu1qG9kQdTFI7veaA34eiQ1cwFy/sAVsGOKEtZZS9YK0gspABco141ecS4dDAF/szHx/gAn2GwoEF+KTUSy6zTRlnAvP1rDUUG8BNl0aksMGO79EYgtV7z72tTQIDAQAB";
    ...
    */
    ...
    public function execute($request, $authToken = null, $appInfoAuthtoken = null)
    {
        ...
        $sysParams["prod_code"] = $request->getProdCode();
        $sysParams["notify_url"] = $request->getNotifyUrl();
        // $sysParams["abc"] = $request->getNotifyUrl();
        $sysParams["charset"] = $this->postCharset;
