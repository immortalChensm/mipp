...
class Umeng {
    ...
    function sendAndroidBroadcast($msg=[]) {
        ...
        try {
            ...
            $brocast->setPredefinedKeyValue("ticker",           $msg['ticker']);
            $brocast->setPredefinedKeyValue("title",            $msg['title']);
            $brocast->setPredefinedKeyValue("text",             $msg['text']);
            $brocast->setPredefinedKeyValue("img",             $msg['img']);
            $brocast->setPredefinedKeyValue("after_open",       "go_custom");
            $brocast->setPredefinedKeyValue("custom",       "nongding");
            //  $brocast->setPredefinedKeyValue("description", $msg['description']);

            // Set 'production_mode' to 'false' if it's a test device.
            // For how to register a test device, please see the developer doc.
            $brocast->setPredefinedKeyValue("production_mode", "true");
            $brocast->setPredefinedKeyValue("builder_id",       1);
            // [optional]Set extra fields
            $brocast->setExtraField("url", $msg['site_url']);
            $brocast->setExtraField("text",             $msg['text']);
            $brocast->setExtraField("message_type", $msg['message_type']);
            // $brocast->setExtraField("description", $msg['description']);
            // $brocast->setExtraField("description", $msg['description']);
            //$brocast->setExtraField("ticker",           $msg['ticker']);
    ...
    function sendAndroidUnicast($msg) {
        try {
            ...
            $unicast->setPredefinedKeyValue("ticker",           $msg['ticker']);
            $unicast->setPredefinedKeyValue("title",            $msg['title']);
            $unicast->setPredefinedKeyValue("text",             $msg['text']);
    ...
    function sendIOSBroadcast($msg=[]) {
        try {
            ...
            $brocast->setPredefinedKeyValue("alert", $msg['alert']);
            $brocast->setPredefinedKeyValue("badge", 0);
            $brocast->setPredefinedKeyValue("sound", "chime");
            // Set 'production_mode' to 'true' if your app is under production mode
            $brocast->setPredefinedKeyValue("production_mode", "false");
            // Set customized fields
            $brocast->setCustomizedField("url", $msg['site_url']);
            $brocast->setCustomizedField("description", $msg['description']);
            $brocast->setCustomizedField("message_type", $msg['message_type']);
            $brocast->setCustomizedField("img", $msg['img']);
