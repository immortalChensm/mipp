...
class ChuanglanSmsApi {
	...
	//创蓝账号 替换成你自己的账号
	const API_ACCOUNT	= 'BG1RTWL_anpinwang';
	
	//创蓝密码 替换成你自己的密码
	const API_PASSWORD	= 'Anpinwang666';
	/**
	 * 发送短信
	 *
	...
	public function sendSMS( $mobile, $msg, $needstatus = 'false', $extno = '') {
		//创蓝接口参数
		$postArr = array (
				          'account' => iconv('GB2312', 'GB2312',self::API_ACCOUNT),
				          'pswd' => iconv('GB2312', 'GB2312',self::API_PASSWORD),
