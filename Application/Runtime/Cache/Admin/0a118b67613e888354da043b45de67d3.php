	...
	$('.nav-tabs').find('li[name='+act_nav+']').addClass('active');
	               	...
	               	<nav class="navbar navbar-default">	     
				        <div class="collapse navbar-collapse">
				          <form class="navbar-form form-inline" action="<?php echo U('Course/index');?>" method="get">
		              ...
		              <table id="list-table" class="table table-bordered table-striped dataTable">
						...
						<tbody>
						  <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr role="row" align="center">
		                     ...
		                     <?php if($vo["status"] == 1): ?><td><img style="cursor:pointer;" width="20" height="20" src="/Public/images/yes.png" onclick="set_status(this,'<?php echo ($vo["id"]); ?>','1')"/>  </td>
		                     <?php else: ?>
		                     <td><img style="cursor:pointer;" width="20" height="20" src="/Public/images/cancel.png" onclick="set_status(this,'<?php echo ($vo["id"]); ?>','2')"/>  </td><?php endif; ?>
		                     <td><?php echo ($vo["check_time"]); ?></td>
		                     <td>
		                       <?php if($admin_info["type"] == 2): ?><a title="编辑信息" class="btn btn-primary" href="<?php echo U('Course/edit',array('id'=>$vo['id']));?>"><i class="fa fa-pencil"></i></a><?php endif; ?>
