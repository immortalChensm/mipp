...
<body class="skin-blue-light sidebar-mini" style="overflow-y:hidden;">
<div class="wrapper">
...
<!--         <span class="logo-lg" ><img src="/Public/images/recruit_logo.png" height="30">&nbsp;&nbsp;</span> -->
        <span class="logo-lg" style="font-family: inherit;">C2C艺术教育</span>
      </a>
      ...
      <nav class="navbar navbar-static-top" role="navigation">
        ...
        <div class="navbar-custom-menu">
          ...
          <?php if($upgradeMsg[0] != null): ?><li>
           ...
           <?php if($over_admin_info != null): ?><li>
           	  <a href="<?php echo U('Admin/over_login_back');?>">
           ...
           <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                ...
                <span class="hidden-xs">欢迎：<?php echo $admin_info['role_name']?$admin_info['role_name']:$admin_info['user_name'];?></span>
              </a>
              <ul class="dropdown-menu">
                <li class="user-footer">
                  <div class="pull-left">
                  	<a href="<?php echo U('Index/index');?>" data-url="" class="btn btn-default btn-flat model-map">后台首页</a>
                   	<a href="<?php echo U('Admin/edit_pass',array('id'=>$admin_info['id']));?>" target="rightContent" class="btn btn-default btn-flat">修改密码</a>
...
<?php if($admin_info["type"] == 3): ?><script>
$(function(){
	$('.treeview-menu').slideDown();
      ...
      <section class="sidebar">
        <!-- search form -->
        <form action="<?php echo U('Index/websearch');?>" method="get" class="sidebar-form">
...
<section class="content-wrapper right-side" id="riframe" style="margin:0px;padding:0px;margin-left:230px;">
    ...
    <iframe id='rightContent' name='rightContent' src="<?php echo ($comtroller_url); ?>" width='100%' frameborder="0"></iframe>
