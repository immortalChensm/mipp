	             ...
	             <div class="box-header">
	               	<nav class="navbar navbar-default">	     
				        <div class="collapse navbar-collapse">
				          <form class="navbar-form form-inline" action="<?php echo U('Order/yuyue_order');?>" method="get">
				            <div class="form-group">
				              	...
				              	<option value="1" <?php echo $request_data['status'] == 1 ? 'selected':'';?> >预约中</option>
		              ...
		              <table id="list-table" class="table table-bordered table-striped dataTable">
						...
						<tbody>
						  <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr role="row" align="center">
		                     ...
		                     <?php if($vo["status"] == 1): ?><td style="color:#25be13;">预约中</td>
