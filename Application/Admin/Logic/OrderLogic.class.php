...
class OrderLogic extends RelationModel
{
     ...
     */
    public function deliveryHandle($data,$store_id=1){
        $store_id=1;
        ...
        $data['invoice_no'] =!empty($data['invoice_no'])?$data['invoice_no']:"自提";
		...
		$s = $this->orderActionLog($order['order_id'],'delivery',$data['note'],session('admin_id'));//操作日志
		return $s && $r;
    }
