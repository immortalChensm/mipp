...
// 修改指定表的指定字段值
function changeGoodsVal(table,id_name,id_value,field,obj)
{
    var src = "";
    ...
    $.ajax({
        url:"/index.php?m=Admin&c=Index&a=changeGoodsVal&table="+table+"&id_name="+id_name+"&id_value="+id_value+"&field="+field+'&value='+value,
